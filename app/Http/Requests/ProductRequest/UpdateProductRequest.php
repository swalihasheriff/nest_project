...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'ctn_barcode' => 'required|string|max:255|unique:products,ctn_barcode,' . $productId,
            'upc' => 'required|string|max:100',
            'product_barcode1' => 'required|string|max:255|unique:products,product_barcode1,' . $productId,
